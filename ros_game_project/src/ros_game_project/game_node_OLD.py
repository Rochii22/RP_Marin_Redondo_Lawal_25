...
# Screen size - Full screen dimensions
...
# Player color (Enhanced PURPLE)
PLAYER_COLOR = (155, 89, 182)

# Player configuration
PLAYER_SIZE = int(40 * SCALE_FACTOR)
PLAYER_LIVES = 3
JUMP_DISTANCE = int(60 * SCALE_FACTOR)  # Distance of each jump

# Collision system
INSTANT_DEATH = False

# Difficulty configuration
BASE_ENEMY_SPEED = 2 * SCALE_FACTOR
    ...
    def draw(self, screen, camera_y):
        ...
        if -50 < screen_y < SCREEN_HEIGHT + 50:
            ...
            if self.invincible_timer > 0 and (self.invincible_timer // 10) % 2 == 0:
                ...
                color = PLAYER_COLOR
                glow_color = (175, 119, 202)  # Lighter purple for glow
...
class Game:
    ...
    def __init__(self):
        ...
        self.last_command = None # Store command
        self.username = None
        self.name = None
        self.age = None
    ...
    def update_difficulty(self):
        ...
        self.difficulty_multiplier = 1.0 + (height_reached * 0.01)
